...
<div class="container">
        ...
        <table class="table table-bordered table-hover table-stripped">
            <tr><th>PRENOM</th><th>NOM</th><th>ADRESSE</th><th>SEXE</th><th>NATIONALITE</th><th>ACTIONS</th></tr>
            <?php
            ...
            while($data = $result->fetch()){
                ...
                if($archive==0){
                echo "<tr><td>$prenom</td><td>$nom</td><td>$adresse</td><td>$sexe</td><td>$nationalite</td>";
